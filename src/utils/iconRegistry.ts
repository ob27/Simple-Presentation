...
export const CURATED_ICON_CATEGORIES: { category: string; icons: string[] }[] = [
  ...
  },
  {
    ...
    icons: [
      ...
      'StockOutlined', 'DollarCircleOutlined', 'EuroCircleOutlined', 'PoundCircleOutlined', 'GoldOutlined',
      'TransactionOutlined', 'ReconciliationOutlined', 'RedEnvelopeOutlined', 'RiseOutlined', 'FallOutlined',
      'PayCircleOutlined', 'PercentageOutlined',
    ],
  },
  {
    ...
    icons: [
      ...
      'RadiusSettingOutlined', 'LayoutOutlined', 'GroupOutlined', 'UngroupOutlined', 'TableOutlined',
      'BorderlessTableOutlined', 'OneToOneOutlined', 'ExpandOutlined', 'CompressOutlined', 'ExpandAltOutlined',
      'ShrinkOutlined', 'ZoomInOutlined', 'ZoomOutOutlined', 'PicCenterOutlined', 'PicLeftOutlined', 'PicRightOutlined',
    ],
  },
  {
    category: 'Text & typography',
    icons: [
      'BoldOutlined', 'ItalicOutlined', 'UnderlineOutlined', 'StrikethroughOutlined', 'FontColorsOutlined',
      'FontSizeOutlined', 'FormatPainterOutlined', 'SignatureOutlined', 'TranslationOutlined', 'NumberOutlined',
      'OrderedListOutlined', 'UnorderedListOutlined', 'LineHeightOutlined', 'ColumnHeightOutlined', 'ColumnWidthOutlined',
  ...
  },
  {
    ...
    icons: [
      'CheckCircleOutlined', 'CheckOutlined', 'CheckSquareOutlined', 'CloseCircleOutlined', 'CloseOutlined',
      'CloseSquareOutlined', 'PlusCircleOutlined', 'PlusSquareOutlined', 'MinusCircleOutlined', 'MinusSquareOutlined',
      'QuestionCircleOutlined', 'QuestionOutlined', 'ExclamationOutlined', 'InfoOutlined', 'LikeOutlined',
      'DislikeOutlined', 'FrownOutlined', 'MehOutlined', 'HourglassOutlined', 'ClockCircleOutlined',
      'ScheduleOutlined', 'HistoryOutlined', 'CalendarOutlined', 'SaveOutlined', 'SyncOutlined',
      'ReloadOutlined', 'UndoOutlined', 'RedoOutlined', 'RotateLeftOutlined', 'RotateRightOutlined',
      'PoweroffOutlined', 'VerifiedOutlined', 'TrademarkOutlined', 'CopyrightOutlined', 'CarryOutOutlined',
      'DisconnectOutlined', 'MergeOutlined', 'ScissorOutlined', 'SearchOutlined', 'FilterOutlined',
      'CalculatorOutlined', 'FieldBinaryOutlined', 'FieldNumberOutlined', 'FieldStringOutlined', 'FieldTimeOutlined',
      'FunctionOutlined', 'ConsoleSqlOutlined', 'ExceptionOutlined', 'IssuesCloseOutlined', 'ProductOutlined',
      'PullRequestOutlined', 'DeliveredProcedureOutlined', 'InteractionOutlined', 'MonitorOutlined',
      'FundProjectionScreenOutlined', 'FundViewOutlined', 'SkinOutlined', 'ShakeOutlined', 'AppstoreAddOutlined',
    ],
  },
];
